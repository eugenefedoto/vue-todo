        ...
        <tbody>
          <tr>
            <td align="left" class="td_submit">
              <a href="#" class="ist_button ist_button_red submit_btn" @click="saveTask">
                <span>Save</span>
              </a>
...
export default {
  ...
  props: ['taskName', 'dateProp'],
  methods: {
    saveTask() {
      const taskObj = {
        name: this.taskNameInstance,
        date: this.date
      }
      this.$emit('saveTask', taskObj);
    },
    cancelTask() {
      this.$emit('cancelTask');
      this.taskNameInstance = "";
    },
  },
  components: {
